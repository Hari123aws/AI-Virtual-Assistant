...
// export const Home = () => {
//   const {userData,serverUrl,setUserData,getGeminiResponse} = useContext(userDateContext)
...
//         font-semibold absolute top-[20px] right-[20px] bg-white 
//         rounded-full cursor-pointer text-[19px]' 
//         onClick={handleLogout}>Log Out</button>

//       <button className='min-w-[150px] h-[60px] mt-[30px] text-black 
//         font-semibold bg-white absolute top-[100px] right-[20px] 
