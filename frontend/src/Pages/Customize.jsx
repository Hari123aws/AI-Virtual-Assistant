...
//               text-white w-[25px] h-[25px]' onClick={()=>navigate("/")} />
//       <h1 className='text-white mb-[30px] text-[30px] text-center'>Select 
//         your <span 
//         className='text-blue-200'>Assistant Image</span>
//       </h1>
...
//        overflow-hidden hover:shadow-blue-950
//         cursor-pointer hover:border-4 hover:border-white flex 
//         items-center justify-center $ {selectedImage=="input"? 
//         "border-4 border-white shadow-2xl  shadow-blue-950 ": null}`}
//          onClick={()=>{
...
//         font-semibold cursor-pointer bg-white rounded-full text-[19px]
